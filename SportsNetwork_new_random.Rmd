...
set.seed(12)
training.samples <-  createDataPartition(y=c(1:nrow(pairs)),p = 0.8, list = F)
train_pairs  <- pairs[training.samples, ] %>% mutate(pair = mapply(c, from, to, SIMPLIFY  = F))
...
write.csv(DistsDir, "new_results/Random_DistsDir.csv", row.names = F)
...
write.csv(DistsUndir, "new_results/Random_DistsUndir.csv", row.names = F)
...
DistsUndir <- read.csv("new_results/Random_DistsUndir.csv")
DistsDir <- read.csv("new_results/Random_DistsDir.csv")
...
for (row in c(1:nrow(pairs))){
  ...
  for (col in c(3:18)) {
    ...
    edge_centric_dir[row,col] <- new_lineup[new_lineup$id == i,][[act1]] * new_lineup[new_lineup$id == j,][[act2]] / (DistsDir[row,col])
    #edge_centric_undir[row,col] <- new_lineup[new_lineup$id == i,][[act1]] * new_lineup[new_lineup$id == j,][[act2]] / (DistsUndir[row,col]**2)

  }
}

#write.csv(edge_centric_dir, "new_results/Random_edge_centric_dir_quadratic.csv", row.names = F)
#write.csv(edge_centric_undir, "new_results/Random_edge_centric_undir_quadratic.csv", row.names = F)

write.csv(edge_centric_dir, "new_results/Random_edge_centric_dir_linear.csv", row.names = F)
#write.csv(edge_centric_undir, "new_results/Random_edge_centric_undir_linear.csv", row.names = F)
```
...
```{r warning=FALSE}
#edge_centric_dir <- read.csv("new_results/Random_edge_centric_dir_quadratic.csv")
#edge_centric_undir <- read.csv("new_results/Random_edge_centric_undir_quadratic.csv")

edge_centric_dir <- read.csv("new_results/Random_edge_centric_dir_linear.csv")
#edge_centric_undir <- read.csv("new_results/Random_edge_centric_undir_linear.csv")
