...
```{r warning=FALSE}
edge_centric <- read.csv("edge_centric.csv")
edge_centric_dir <- read.csv("edge_centric_dir.csv")
edge_centric_undir <- read.csv("edge_centric_undir.csv")
...
#model <- gausspr(x=X_small, y=y_small, kernel="rbfdot")
model <- gausspr(formula = result ~ Pin_Pout+Pin_Nout+Nin_Pout+Nin_Nout+Pin_Pin+Pin_Nin+Nin_Pin+Nin_Nin+Pout_Pin+Pout_Nin+Nout_Pin+Nout_Nin+Pout_Pout+Pout_Nout+Nout_Pout+Nout_Nout, data=GPData, kernel="rbfdot")
summary(model)
